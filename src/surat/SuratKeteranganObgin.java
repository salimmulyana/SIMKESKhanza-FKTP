 ...
 * @author salimmulyana
 */
public final class SuratKeteranganObgin extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratKeteranganObgin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat","No.Rawat","No.R.M.","Nama Pasien","Tanggal Pemeriksaan","Letak Janin","Letak Placenta","Air Ketuban",
            "DJJ","TBJ","Kesan"
        }){
    ...
    private void initComponents() {
        ...
        MnCetakSuratHamil.setBackground(new java.awt.Color(250, 250, 250));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat Keterangan Hasil Pemeriksaan Poli Obgin ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-01-2021" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-01-2021" }));
        ...
        jLabel13.setText("Tgl Pemeriksaan:");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(246, 40, 84, 23);

        jLabel14.setText("Kesan:");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(20, 180, 110, 23);

        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-01-2021" }));
        TanggalPeriksa.setDisplayFormat("dd-MM-yyyy");
        TanggalPeriksa.setName("TanggalPeriksa"); // NOI18N
        FormInput.add(TanggalPeriksa);
        TanggalPeriksa.setBounds(340, 40, 80, 23);

        jLabel15.setText("Hasil Pemeriksaan");
        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(20, 70, 110, 23);

        jLabel16.setText("Letak janin:");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(20, 90, 110, 23);

        jLabel17.setText("Placenta:");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(300, 90, 50, 20);

        jLabel18.setText("Air ketuban:");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(20, 120, 110, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("kali/menit");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(450, 120, 60, 23);

        jLabel22.setText("TBJ:");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(20, 150, 110, 23);

        Tbj.setName("Tbj"); // NOI18N
        FormInput.add(Tbj);
        Tbj.setBounds(140, 150, 80, 24);

        Djj.setName("Djj"); // NOI18N
        FormInput.add(Djj);
        Djj.setBounds(360, 120, 80, 24);
        ...
        jScrollPane1.setViewportView(Kesan);

        FormInput.add(jScrollPane1);
        jScrollPane1.setBounds(140, 180, 440, 83);

        jLabel21.setText("DJJ:");
        jLabel21.setName("jLabel21"); // NOI18N
        FormInput.add(jLabel21);
        jLabel21.setBounds(310, 120, 40, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("gram");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(230, 150, 40, 23);

        cmbJanin.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Presentasi kepala", "Presentasi bokong", "Lintang" }));
        cmbJanin.setName("cmbJanin"); // NOI18N
        FormInput.add(cmbJanin);
        cmbJanin.setBounds(140, 90, 130, 23);

        cmbKetuban.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Cukup", "Lebih", "Kurang" }));
        cmbKetuban.setName("cmbKetuban"); // NOI18N
        FormInput.add(cmbKetuban);
        cmbKetuban.setBounds(140, 120, 110, 23);

        cmbPlacenta.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Fundus", "Corpus", "SBR", "Anterior", "Posterior", "Lateral", "Kanan", "Kiri", "Mencapai tepi OUI", "Menutupi OUI sebagian", "Menutupi OUI totalis", "Berada dari tepi OUI" }));
        cmbPlacenta.setName("cmbPlacenta"); // NOI18N
        FormInput.add(cmbPlacenta);
        cmbPlacenta.setBounds(360, 90, 180, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_obgin","?,?,?,?,?,?,?,?,?","No.Surat",9,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalPeriksa.getSelectedItem()+""),cmbJanin.getSelectedItem()+"",
                    cmbPlacenta.getSelectedItem()+"",cmbKetuban.getSelectedItem()+"",Djj.getText(),Tbj.getText(),Kesan.getText()
            })==true){
                tampil();
                emptTeks();
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode,NoSurat,"surat_obgin","no_surat");
        tampil();
        emptTeks();
        ...
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_hamil","no_surat=?","no_surat=?,no_rawat=?,tanggalperiksa=?,hasilperiksa=?",5,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalPeriksa.getSelectedItem()+""),cmbJanin.getSelectedItem()+"",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                        })==true){
                    tampil();
                    emptTeks();
                }
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                ...
                Valid.MyReportqry("rptDataSuratHamil.jasper","report","::[ Data Surat Keterangan Hamil/Tidak Hamil ]::",
                     ...
                     tgl+"and surat_hamil.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     tgl+"and surat_hamil.tanggalperiksa like '%"+TCari.getText().trim()+"%' "+
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratKeteranganObgin dialog = new SuratKeteranganObgin(new javax.swing.JFrame(), true);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            cmbJanin.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString());               
...
public void nomorSurat() {
        ...
        Valid.autoNomerSuratKhusus("select ifnull(MAX(CONVERT(LEFT(no_surat,3),signed)),0) from surat_hamil where "
                + "tanggalperiksa='" + Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"") + "' ", "/SKH/" + bln_romawi + "/" + TanggalPeriksa.getSelectedItem().toString().substring(6,10), 3, NoSurat);
    }
}
