...
public final class SuratTidakHamil extends javax.swing.JDialog {
    ...
    public SuratTidakHamil(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat","No.Rawat","No.R.M.","Nama Pasien","Tanggal Pemeriksaan","Hasil Pemeriksaan"
        }){
    ...
    private void initComponents() {
        ...
        HasilPeriksa.setBounds(520, 40, 222, 23);
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-05-2020" }));
