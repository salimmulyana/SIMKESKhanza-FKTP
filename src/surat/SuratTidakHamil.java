...
public final class SuratTidakHamil extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cmbHamilTidak = new widget.ComboBox();
        ...
        cmbHamilTidak.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "tidak ditemukan tanda-tanda kehamilan", "ditemukan tanda-tanda kehamilan" }));
        cmbHamilTidak.setName("cmbHamilTidak"); // NOI18N
        FormInput.add(cmbHamilTidak);
        cmbHamilTidak.setBounds(520, 40, 222, 23);

        jLabel14.setText("Hasil Pemeriksaan:");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(410, 40, 110, 23);

        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-04-2020" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("suratsakit","?,?,?,?,?","No.Surat Sakit",5,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalPeriksa.getSelectedItem()+""),Valid.SetTgl(TanggalAkhir.getSelectedItem()+""),LamaSakit.getText()
                })==true){
                tampil();
                emptTeks();
            }
    ...
    private void MnCetakSuratSakit5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakit5ActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            Map<String, Object> param = new HashMap<>();
            param.put("periksa",TanggalPeriksa.getSelectedItem().toString());
    ...
    */
    ...
    private widget.ComboBox cmbHamilTidak;
