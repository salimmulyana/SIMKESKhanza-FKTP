...
public final class SuratBebasNarkoba extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NoSurat.setBounds(74, 40, 180, 23);
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-07-2020" }));
    ...
    */
    ...
    public void nomorSurat() {
        ...
        Valid.autoNomerSuratKhusus("select ifnull(MAX(CONVERT(LEFT(no_surat,3),signed)),0) from surat_skbn where "
                + "tanggalsurat like '%" + Valid.SetTgl(TanggalSurat.getSelectedItem()+"").substring(0, 7) + "%' ", "/SKBN/MCU/" + bln_romawi + "/" + Valid.SetTgl(TanggalSurat.getSelectedItem() + "").substring(0, 4), 3, NoSurat);
    }
