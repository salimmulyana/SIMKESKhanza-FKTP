...
public final class SuratKeteranganCovid extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakSuratCovid.setText("Cetak Surat Keterangan Covid 1");
        ...
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-12-2020" }));
        ...
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-12-2020" }));
...
//                "SKRT"+TanggalAwal.getSelectedItem().toString().substring(6,10)+TanggalAwal.getSelectedItem().toString().substring(3,5)+TanggalAwal.getSelectedItem().toString().substring(0,2),3,NoSurat); 
    ...
    public void nomorSurat() {
        bln_angka = "";
        bln_romawi = "";
        bln_angka = Sequel.cariIsi("SELECT MONTH(berlakumulai) bln FROM surat_keterangan_covid WHERE berlakumulai like '%" + Valid.SetTgl(TanggalAwal.getSelectedItem() + "").substring(0, 7) + "%'");
        ...
        Valid.autoNomerSuratKhusus("select ifnull(MAX(CONVERT(LEFT(no_surat,3),signed)),0) from surat_keterangan_covid where "
                + "berlakumulai like '%" + Valid.SetTgl(TanggalAwal.getSelectedItem() + "").substring(0, 7) + "%' ", "/SCov19/Klinik/" + bln_romawi + "/" + Valid.SetTgl(TanggalAwal.getSelectedItem() + "").substring(0, 4), 3, NoSurat);
    }
}
