    ...
    */
    ...
    private void tampil(String user) {        
        try{    
            ...
            ps=koneksi.prepareStatement("select penyakit, obat_penyakit, dokter, jadwal_praktek, petugas, pasien, registrasi, tindakan_ralan,"+
                        ...
                        "barang_cssd,skdp_bpjs,surat_kontrol,booking_registrasi,bpjs_cek_propinsi,bpjs_cek_kabupaten,bpjs_cek_kecamatan, "+
                        ...
                        "toko_bayar_piutang,toko_piutang_harian,toko_penjualan_harian,deteksi_corona,surat_kontrol,surat_keterangan_covid from user where id_user=AES_ENCRYPT(?,'nur')");
            try {
                ps.setString(1,user);
                rs=ps.executeQuery();
                while(rs.next()){
                    ...
                    if("Surat Kontrol".toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{false,"Surat Kontrol",rs.getBoolean("surat_kontrol")});
                    }
                    ...
                    if("Surat Keterangan Covid".toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{false,"Surat Keterangan Covid",rs.getBoolean("surat_keterangan_covid")});
                    }
                }       
    ...
    private void Simpan2() {
        for(i=0;i<tbUser.getRowCount();i++){ 
            ...
            if("Surat Kontrol".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","surat_kontrol='"+tbUser.getValueAt(i,2).toString()+"'");
            }
            ...
            if("Surat Keterangan Covid".equals(tbUser.getValueAt(i,1).toString())){
