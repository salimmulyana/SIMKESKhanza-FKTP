 ...
 * @author dosen
 */
public final class DlgGroupPenjab extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgGroupPenjab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Group Penjab ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"kode group");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"nama group");
        }else{
            Sequel.menyimpan("c_group_penjab","?,?","Kode group",2,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbKategori.getRowCount();i++){ 
            if(tbKategori.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("c_group_penjab","kd_group",tbKategori.getValueAt(i,1).toString());
            }
        } 
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"c_group_penjab","kd_group","?","kd_group=?,nm_group=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgGroupPenjab dialog = new DlgGroupPenjab(new javax.swing.JFrame(), true);
    ...
    private void tampil(){
        ...
        try{
            ps=koneksi.prepareStatement(
                "select * from c_group_penjab where kd_group like ? "+
                "or nm_group like ? ");
            try {
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode,"KG",3,TKd);
    }
