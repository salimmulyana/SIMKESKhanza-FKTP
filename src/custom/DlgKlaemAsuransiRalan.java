 ...
 * @author dosen
 */
public final class DlgKlaemAsuransiRalan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgKlaemAsuransiRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Klaem Asuransi - Ralan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        label34.setText("Group Perusahaan :");
                ...
                try {
                    //koneksi.setAutoCommit(false);                
                        ...
                        if(Sequel.menyimpantf2("c_klaim","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Permintaan",15,new String[]{
                            ...
                            "Proses","Ralan",AkunPiutang.getText(),"-","0"
    ...
    private void BtnCari2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCari2ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));  
        DlgCariKlaemRalan form=new DlgCariKlaemRalan(null,false);
        form.isCek();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKlaemAsuransiRalan dialog = new DlgKlaemAsuransiRalan(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try {
            ps=koneksi.prepareStatement(" select c_billing_klaim.no_rawat, c_billing_klaim.no_rkm_medis, c_billing_klaim.nm_pasien, "+ 
                ...
                " reg_periksa.kd_group!='UMUM' and c_billing_klaim.status_rawat='Ralan' and c_billing_klaim.status_klaim='Belum' and c_billing_klaim.tanggal between ? and ? and penjab.kd_perusahaan like ? and penjab.png_jawab like ? or "+
                " reg_periksa.kd_group!='UMUM' and c_billing_klaim.status_rawat='Ralan' and c_billing_klaim.status_klaim='Belum' and c_billing_klaim.tanggal between ? and ? and penjab.kd_perusahaan like ? and dokter.nm_dokter like ? or "+
                " reg_periksa.kd_group!='UMUM' and c_billing_klaim.status_rawat='Ralan' and c_billing_klaim.status_klaim='Belum' and c_billing_klaim.tanggal between ? and ? and penjab.kd_perusahaan like ? and c_billing_klaim.nm_pasien like ? or "+
                " reg_periksa.kd_group!='UMUM' and c_billing_klaim.status_rawat='Ralan' and c_billing_klaim.status_klaim='Belum' and c_billing_klaim.tanggal between ? and ? and penjab.kd_perusahaan like ? and c_billing_klaim.no_rawat like ? or "+
                " reg_periksa.kd_group!='UMUM' and c_billing_klaim.status_rawat='Ralan' and c_billing_klaim.status_klaim='Belum' and c_billing_klaim.tanggal between ? and ? and penjab.kd_perusahaan like ? and c_billing_klaim.no_rkm_medis like ? ");      
            try{
