 ...
 * @author dosen
 */
public class DlgKecamatan2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgKecamatan2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ps=koneksi.prepareStatement("select nm_kec from kecamatan2 where nm_kec like ? ");
        } catch (Exception e) {
        }
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKecamatan2 dialog = new DlgKecamatan2(new javax.swing.JFrame(), true);
