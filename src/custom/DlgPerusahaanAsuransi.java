 ...
 * @author dosen
 */
public final class DlgPerusahaanAsuransi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPerusahaanAsuransi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(628,674);

        Object[] row={"P","Kode","Nama Perusahaan"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Perusahaan Asuransi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        panelisi4.add(Kd);
        Kd.setBounds(110, 12, 100, 23);

        label36.setText("Nama Perusahaan :");
        label36.setName("label36"); // NOI18N
        label36.setPreferredSize(new java.awt.Dimension(35, 23));
        panelisi4.add(label36);
        label36.setBounds(0, 42, 100, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            Valid.textKosong(Kd,"Kode Perusahaan");       
        }else if(Nm.getText().trim().equals("")){
            Valid.textKosong(Nm,"Nama Perusahaan");
        }else{
            Sequel.menyimpan("c_group_perusahaan","'"+Kd.getText()+"','"+
                    Nm.getText()+"'","Kode Perusahaan");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbKamar.getRowCount();i++){ 
            if(tbKamar.getValueAt(i,0).toString().equals("true")){               
                Sequel.meghapus("c_group_perusahaan","kd_perusahaan",tbKamar.getValueAt(i,1).toString());
            }
        } 
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"c_group_perusahaan","kd_perusahaan",Kd2,"kd_perusahaan='"+Kd.getText()+
                    "',nm_perusahaan='"+Nm.getText()+"'");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPerusahaanAsuransi dialog = new DlgPerusahaanAsuransi(new javax.swing.JFrame(), true);
    ...
    private void tampil(String order) {
        ...
        if(TCari.getText().equals("")){
            sql="select kd_perusahaan, nm_perusahaan "+
                   "from c_group_perusahaan "+order;
        }else if(!TCari.getText().equals("")){
            sql="select kd_perusahaan, nm_perusahaan "+
                " from c_group_perusahaan where kd_perusahaan like '%"+TCari.getText().trim()+"%' or "+
                " nm_perusahaan like '%"+TCari.getText().trim()+"%' "+order;
        } 
        prosesCari(sql);
    }
    ...
    public void emptTeks() {
        ...
        Nm.setText("");
        Kd.requestFocus();        
        Valid.autoNomer("c_group_perusahaan","U",4,Kd);
    }
