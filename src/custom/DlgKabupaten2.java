 ...
 * @author dosen
 */
public class DlgKabupaten2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgKabupaten2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKabupaten2 dialog = new DlgKabupaten2(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{   
            ps=koneksi.prepareStatement("select nm_kab from kabupaten2 where nm_kab like ? ");
            try {
