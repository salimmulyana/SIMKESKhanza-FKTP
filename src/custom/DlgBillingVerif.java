...
public class DlgBillingVerif extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgBillingVerif(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        Object[] rowRwJlDr={
            "P","No.Rawat","No.Nota","Tanggal","Jam","No.RM","Nama Pasien","Total Bayar",
            "Total Hutang","Total Tagihan","Kasir","Status","No.Bukti"
        };
        ...
        //========
        Object[] rowRwJlDr2={
            "P","No.Rawat","No.Nota","Tanggal","Jam","No.RM","Nama Pasien","Deposit","Total Bayar",
            "Total Hutang","Total Tagihan","Kasir","Status","No.Bukti"
        };
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Billing Verif ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        cmbStatusBayar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "Belum", "Kunci", "Bayar" }));
    ...
    if(TabRawat.getSelectedIndex()==0){
        if(TNoRw.getText().trim().equals("")){
             ...
             JOptionPane.showMessageDialog(null,"Maaf, Gagal menghapus. Pasien Sudah dilakukan pembayaran Jasmed, Silahkan hubungi Admin...!!!!");
                ...
                Sequel.queryu2("delete from billing_verif where no_rawat=?",1,new String[]{
                    TNoRw.getText()
                });
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBillingVerif dialog = new DlgBillingVerif(new javax.swing.JFrame(), true);
...
//"No.Rawat","No.Nota","Tanggal","Jam","No.RM","Nama Pasien","Total Bayar",
    ...
    private void tampil() {
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select billing_verif.no_rawat,billing_verif.no_nota, billing_verif.tanggal, billing_verif.jam, reg_periksa.no_rkm_medis, pasien.nm_pasien, "+
                    "billing_verif.besar_bayar, billing_verif.besar_hutang, billing_verif.total, billing_verif.kasir, billing_verif.status_bayar, billing_verif.no_bukti "+
                    "from billing_verif inner join reg_periksa inner join pasien on "+
                    "billing_verif.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis where "+
                    "billing_verif.status='Ralan' and billing_verif.tanggal between ? and ? and billing_verif.status_bayar like ? and billing_verif.no_rawat like ? or "+
                    "billing_verif.status='Ralan' and billing_verif.tanggal between ? and ? and billing_verif.status_bayar like ? and pasien.nm_pasien like ? or "+
                    "billing_verif.status='Ralan' and billing_verif.tanggal between ? and ? and billing_verif.status_bayar like ? and reg_periksa.no_rkm_medis like ? or "+
                    "billing_verif.status='Ralan' and billing_verif.tanggal between ? and ? and billing_verif.status_bayar like ? and billing_verif.no_nota like ? ");   
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{                   
                        false,rs.getString("no_rawat"),rs.getString("no_nota"),rs.getString("tanggal"),rs.getString("jam"),
                        rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),
                        rs.getDouble("besar_bayar"),rs.getDouble("besar_hutang"),rs.getDouble("total"),
                        rs.getString("kasir"),rs.getString("status_bayar"),rs.getString("no_bukti")
                    });                  
    ...
    private void tampil2() {
        ...
        try {
            ps=koneksi.prepareStatement(
                    "select billing_verif.no_rawat,billing_verif.no_nota, billing_verif.tanggal, billing_verif.jam, reg_periksa.no_rkm_medis, pasien.nm_pasien, "+
                    "billing_verif.deposit, billing_verif.besar_bayar, billing_verif.besar_hutang, billing_verif.total, billing_verif.kasir, billing_verif.status_bayar, billing_verif.no_bukti "+
                    "from billing_verif inner join reg_periksa inner join pasien on "+
                    "billing_verif.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis where "+
                    "billing_verif.status='Ranap' and billing_verif.tanggal between ? and ? and billing_verif.status_bayar like ? and billing_verif.no_rawat like ? or "+
                    "billing_verif.status='Ranap' and billing_verif.tanggal between ? and ? and billing_verif.status_bayar like ? and pasien.nm_pasien like ? or "+
                    "billing_verif.status='Ranap' and billing_verif.tanggal between ? and ? and billing_verif.status_bayar like ? and reg_periksa.no_rkm_medis like ? or "+
                    "billing_verif.status='Ranap' and billing_verif.tanggal between ? and ? and billing_verif.status_bayar like ? and billing_verif.no_nota like ? ");   
            try {
                ps.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                ps.setString(3,"%"+cmbStatusBayar.getSelectedItem().toString().replaceAll("Semua","")+"%");
                ...
                while(rs.next()){
                    tabMode2.addRow(new Object[]{                   
                        false,rs.getString("no_rawat"),rs.getString("no_nota"),rs.getString("tanggal"),rs.getString("jam"),
                        rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),
                        rs.getDouble("deposit"),rs.getDouble("besar_bayar"),rs.getDouble("besar_hutang"),rs.getDouble("total"),
                        rs.getString("kasir"),rs.getString("status_bayar"),rs.getString("no_bukti")
                    });                  
    ...
    private void getData() {
        if(tbRadiologiRalan.getSelectedRow()!= -1){
            TNoRw.setText(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),1).toString());
