 ...
 * @author dosen
 */
public final class DlgKtgAlat extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgKtgAlat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"P","Kode Alat","Nama Alat"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Kategori Alat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"kode alat");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"nama alat");
        }else{
            Sequel.menyimpan("c_kategori_alat","?,?","Kode alat",2,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbKategori.getRowCount();i++){ 
            if(tbKategori.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("c_kategori_alat","kd_alat",tbKategori.getValueAt(i,1).toString());
            }
        } 
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"c_kategori_alat","kd_alat","?","kd_alat=?,nm_alat=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKtgAlat dialog = new DlgKtgAlat(new javax.swing.JFrame(), true);
    ...
    private void tampil(){
        ...
        try{
            ps=koneksi.prepareStatement(
                "select * from c_kategori_alat where kd_alat like ? "+
                "or nm_alat like ? ");
            try {
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode,"KA",3,TKd);
    }
