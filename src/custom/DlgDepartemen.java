...
public final class DlgDepartemen extends javax.swing.JDialog {
    ...
    public DlgDepartemen(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"P","Kode Dept","Nama Departemen"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.menyimpan("departemen","?,?","Kode alat",2,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbKategori.getRowCount();i++){ 
            if(tbKategori.getValueAt(i,0).toString().equals("true")){
                Sequel.meghapus("departemen","dep_id",tbKategori.getValueAt(i,1).toString());
            }
        } 
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"departemen","dep_id","?","dep_id=?,nama=?",3,new String[]{
    ...
    */
    ...
    private void tampil(){
        ...
        try{
            ps=koneksi.prepareStatement(
                "select * from departemen where dep_id like ? "+
                "or nama like ? ");
            try {
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(tabMode,"DP",3,TKd);
    }
