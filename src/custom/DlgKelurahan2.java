 ...
 * @author dosen
 */
public class DlgKelurahan2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgKelurahan2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={"Kode Kelurahan","Kelurahan","Kecamatan","Kabupaten","Propinsi"};
        ...
        try {
            ps=koneksi.prepareStatement("select kelurahan2.kd_kel,kelurahan2.nm_kel,kecamatan2.nm_kec,kabupaten2.nm_kab,propinsi2.nm_prop from kelurahan2 inner join kecamatan2 inner join kabupaten2 inner join propinsi2 on "+
                                        "kelurahan2.kd_kec=kecamatan2.kd_kec and kelurahan2.kd_kab=kabupaten2.kd_kab and kelurahan2.kd_prop=propinsi2.kd_prop where kelurahan2.nm_kel like ? order by kelurahan2.nm_kel desc limit ?  ");
        } catch (Exception e) {
        }
    }
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Kelurahan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        jLabel9.setBounds(670, 10, 70, 23);
        ...
        panelGlass7.add(cmbHlm);
        cmbHlm.setBounds(750, 10, 90, 23);
        ...
        jLabel8.setText("Kelurahan/Kecamatan :");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKelurahan2 dialog = new DlgKelurahan2(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{            
            ...
            ps.setInt(2,Integer.parseInt(cmbHlm.getSelectedItem().toString()));
            rs=ps.executeQuery();
            while(rs.next()){                
    ...
    private void tampilCari() {
        ...
        if(CMbTCari.getSelectedItem()=="Kelurahan"){           
            try{ 
                ps3=koneksi.prepareStatement("select kelurahan2.kd_kel,kelurahan2.nm_kel,kecamatan2.nm_kec,kabupaten2.nm_kab,propinsi2.nm_prop from kelurahan2 inner join kecamatan2 inner join kabupaten2 inner join propinsi2 on "+
                                        "kelurahan2.kd_kec=kecamatan2.kd_kec and kelurahan2.kd_kab=kabupaten2.kd_kab and kelurahan2.kd_prop=propinsi2.kd_prop where kelurahan2.nm_kel like ? order by kelurahan2.nm_kel desc limit ?  ");
                ps3.setString(1,"%"+TCari.getText().trim()+"%");
                ps3.setInt(2,Integer.parseInt(cmbHlm.getSelectedItem().toString()));            
        ...
        }else if(CMbTCari.getSelectedItem()=="Kecamatan"){
            try{      
                ps2=koneksi.prepareStatement("select kelurahan2.kd_kel,kelurahan2.nm_kel,kecamatan2.nm_kec,kabupaten2.nm_kab,propinsi2.nm_prop from kelurahan2 inner join kecamatan2 inner join kabupaten2 inner join propinsi2 on "+
                                            "kelurahan2.kd_kec=kecamatan2.kd_kec and kelurahan2.kd_kab=kabupaten2.kd_kab and kelurahan2.kd_prop=propinsi2.kd_prop where kecamatan2.nm_kec like ? limit ? ");
                ps2.setString(1,"%"+TCari.getText().trim()+"%");
                ps2.setInt(2,Integer.parseInt(cmbHlm.getSelectedItem().toString())); 
