...
public class DlgCariKlaemRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariKlaemRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Klaem Ranap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
    if(TCari.getText().trim().equals("")){
         JOptionPane.showMessageDialog(null,"Maaf, Gagal menghapus. Pilih dulu data yang mau dihapus.\nKlik data pada table untuk memilih...!!!!");
            ...
            jur.simpanJurnal(TCari.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),"U","PEMBATALAN BAYAR PIUTANG KLAEM RANAP"+", OLEH "+akses.getkode());                   
            //======
            TCari.setText("");
            BtnCariActionPerformed(null);
                        ...
                        try {                                             
                                ...
                                if(Sequel.mengedittf("c_klaim","no_klaim=?","status_klaim=?,rek_bayar=?,jml_terklaim=jml_terklaim+? ",4,new String[]{
                                    ...
                                    if(Double.parseDouble(Discount.getText())==0){
                                        ...
                                        jur.simpanJurnal(TNoPermintaanRalan.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),"U","BAYAR PIUTANG KLAEM RANAP"+", OLEH "+akses.getkode());                   
                                    }else{
                                        Sequel.queryu("delete from tampjurnal");  
                                        //===
                                        //Sequel.menyimpan("tampjurnal","'"+RekPiutang.getText()+"','"+RekPiutangNm.getText()+"','0','"+JmlTerklaem.getText()+"'","Rekening"); 
                                        ...
                                        //Sequel.menyimpan("tampjurnal","'540101','POTONGAN BIAYA PASIEN RAWAT INAP','"+Discount.getText()+"','0'","Rekening");
                        ...
                        //})==true){
                            ...
                            //==================================
                                if(Double.parseDouble(Discount.getText())==0){
                                    ...
                                    //Sequel.menyimpan("tampjurnal","'540101','POTONGAN BIAYA PASIEN RAWAT INAP','0','"+Discount.getText()+"'","Rekening");
                                    ...
                                    Sequel.menyimpan("tampjurnal","'"+RekBayar.getText()+"','"+RekBayarNm.getText()+"','0','"+SudahTerklaem.getText()+"'","Rekening"); 
                                    Sequel.menyimpan("tampjurnal","'540101','POTONGAN BIAYA PASIEN RAWAT INAP','0','"+Discount.getText()+"'","Rekening");
                                    jur.simpanJurnal(TNoPermintaanRalan.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),"U","PEMBATALAN BAYAR PIUTANG KLAEM RANAP"+", OLEH "+akses.getkode());                   
                                }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariKlaemRanap dialog = new DlgCariKlaemRanap(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "c_klaim.status_rawat='Ranap' and c_klaim.tanggal between ? and ? and c_klaim.status_klaim like ? and c_klaim.no_klaim like ? or "+
                    "c_klaim.status_rawat='Ranap' and c_klaim.tanggal between ? and ? and c_klaim.status_klaim like ? and c_group_perusahaan.nm_perusahaan like ? order by c_klaim.no_klaim ");   
            try {
    ...
    private void tampil2() {
        ...
        try {
            ps=koneksi.prepareStatement(" select c_klaim_detail.no_rawat,c_klaim_detail.no_rkm_medis,c_klaim_detail.nm_pasien,c_klaim_detail.nm_dokter,c_klaim_detail.perusahaan, "+ 
                ...
                " c_klaim.status_rawat='Ranap' and c_klaim.status_klaim like ? and c_klaim_detail.tanggal_klaem between ? and ? and c_klaim_detail.perusahaan like ? and c_klaim_detail.nm_pasien like ? or "+
                " c_klaim.status_rawat='Ranap' and c_klaim.status_klaim like ? and c_klaim_detail.tanggal_klaem between ? and ? and c_klaim_detail.perusahaan like ? and c_klaim_detail.no_rawat like ? or "+
                " c_klaim.status_rawat='Ranap' and c_klaim.status_klaim like ? and c_klaim_detail.tanggal_klaem between ? and ? and c_klaim_detail.perusahaan like ? and c_klaim_detail.no_klaim like ? or "+    
                " c_klaim.status_rawat='Ranap' and c_klaim.status_klaim like ? and c_klaim_detail.tanggal_klaem between ? and ? and c_klaim_detail.perusahaan like ? and c_klaim_detail.no_rkm_medis like ? ");      
            try{ 
