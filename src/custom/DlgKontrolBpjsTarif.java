 ...
 * @author dosen
 */
public final class DlgKontrolBpjsTarif extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgKontrolBpjsTarif(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10,2);
        setSize(628,674);

        Object[] row={"P","Kode Diagnosa","Nama Diagnosa","Kelas3","Kelas2","Kelas1","VIP"};
        ...
        Kelas3.setDocument(new batasInput((byte)13).getOnlyAngka(Kelas3));        
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Kontrol BPJS - Input Tarif Klaem BPJS ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        panelisi4.setPreferredSize(new java.awt.Dimension(100, 160));
        ...
        label34.setBounds(5, 12, 85, 23);

        label32.setText("Kelas3 :");
        label32.setName("label32"); // NOI18N
        label32.setPreferredSize(new java.awt.Dimension(35, 23));
        panelisi4.add(label32);
        label32.setBounds(10, 75, 80, 23);
        ...
        panelisi4.add(Kd);
        Kd.setBounds(95, 12, 100, 23);

        Kelas3.setText("0");
        Kelas3.setHighlighter(null);
        Kelas3.setName("Kelas3"); // NOI18N
        panelisi4.add(Kelas3);
        Kelas3.setBounds(95, 75, 150, 23);

        label36.setText("Nama Diagnosa :");
        label36.setName("label36"); // NOI18N
        label36.setPreferredSize(new java.awt.Dimension(35, 23));
        panelisi4.add(label36);
        label36.setBounds(5, 42, 85, 23);
        ...
        panelisi4.add(Nm);
        Nm.setBounds(95, 42, 528, 23);

        label33.setText("Kelas2 :");
        label33.setName("label33"); // NOI18N
        label33.setPreferredSize(new java.awt.Dimension(35, 23));
        panelisi4.add(label33);
        label33.setBounds(10, 105, 80, 23);

        Kelas2.setText("0");
        Kelas2.setHighlighter(null);
        Kelas2.setName("Kelas2"); // NOI18N
        panelisi4.add(Kelas2);
        Kelas2.setBounds(95, 105, 150, 23);

        label35.setText("Kelas1 :");
        label35.setName("label35"); // NOI18N
        label35.setPreferredSize(new java.awt.Dimension(35, 23));
        panelisi4.add(label35);
        label35.setBounds(250, 75, 80, 23);

        Kelas1.setText("0");
        Kelas1.setHighlighter(null);
        Kelas1.setName("Kelas1"); // NOI18N
        panelisi4.add(Kelas1);
        Kelas1.setBounds(340, 75, 150, 23);

        label37.setText("VIP :");
        label37.setName("label37"); // NOI18N
        label37.setPreferredSize(new java.awt.Dimension(35, 23));
        panelisi4.add(label37);
        label37.setBounds(250, 105, 80, 23);

        vip.setText("0");
        vip.setHighlighter(null);
        vip.setName("vip"); // NOI18N
        panelisi4.add(vip);
        vip.setBounds(340, 105, 150, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.textKosong(Kelas3,"Kelas3"); 
        }else if(Kelas2.getText().trim().equals("")){
            Valid.textKosong(Kelas2,"Kelas2"); 
        }else if(Kelas1.getText().trim().equals("")){
            Valid.textKosong(Kelas3,"Kelas1"); 
        }else if(vip.getText().trim().equals("")){
            Valid.textKosong(Kelas3,"VIP"); 
        }else{
            Sequel.menyimpan("c_tarif_bpjs","'"+Kd.getText()+"','"+
                    Nm.getText()+"','"+
                    Kelas3.getText()+"','"+
                    Kelas2.getText()+"','"+
                    Kelas1.getText()+"','"+
                    vip.getText()+"'","Kode Diagnosa");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbKamar.getRowCount();i++){ 
            if(tbKamar.getValueAt(i,0).toString().equals("true")){
                Sequel.queryu2("delete from c_tarif_bpjs where kd_penyakit='"+tbKamar.getValueAt(i,1).toString()+"'");           
            }
        } 
        BtnCariActionPerformed(evt);
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.editTable(tabMode,"c_tarif_bpjs","kd_penyakit",Kd2,"kd_penyakit='"+Kd.getText()+"',nm_penyakit='"+Nm.getText()+
                    "',kelas3='"+Kelas3.getText()+"',kelas2='"+Kelas2.getText()+"',kelas1='"+Kelas1.getText()+"',vip='"+vip.getText()+"'");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKontrolBpjsTarif dialog = new DlgKontrolBpjsTarif(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox vip;
    // End of variables declaration//GEN-END:variables

    private void tampil() {
        Valid.tabelKosong(tabMode);
        try {
            ps=koneksi.prepareStatement("select kd_penyakit, nm_penyakit, kelas3, kelas2, kelas1, vip "+
                "from c_tarif_bpjs where kd_penyakit like '%"+TCari.getText().trim()+"%' or "+
                " nm_penyakit like '%"+TCari.getText().trim()+"%' ");           
            try{
                rs=ps.executeQuery();
                while(rs.next()){
...
//"P","Kode Diagnosa","Nama Diagnosa","Tarif","Percent(%)","Batas Tarif"};
    private void getData() {
        if(tbKamar.getSelectedRow()!= -1){
            ...
            Kelas3.setText(Valid.SetAngka2(Double.parseDouble(tbKamar.getValueAt(tbKamar.getSelectedRow(),3).toString())));
            Kelas2.setText(Valid.SetAngka2(Double.parseDouble(tbKamar.getValueAt(tbKamar.getSelectedRow(),4).toString())));
            Kelas1.setText(Valid.SetAngka2(Double.parseDouble(tbKamar.getValueAt(tbKamar.getSelectedRow(),5).toString())));
            vip.setText(Valid.SetAngka2(Double.parseDouble(tbKamar.getValueAt(tbKamar.getSelectedRow(),6).toString())));
        }
    }
