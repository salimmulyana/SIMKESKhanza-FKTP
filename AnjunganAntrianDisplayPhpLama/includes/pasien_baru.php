											      ...
											      <div class="card-header" style="font-size:41px;">Kasir</div>
												    ...
												    <div class="card-footer p-0">
															<div class="btn-group btn-group-justified">
															  ...
															  <a href="antrian.php?action=baru&loket=4" class="btn btn-primary" style="font-size:41px;" style="font-size:41px;" style="font-size:41px;"><i class="fas fa-forward"></i></a>
															</div>
												    </div>
												  </div>
												  </div>
