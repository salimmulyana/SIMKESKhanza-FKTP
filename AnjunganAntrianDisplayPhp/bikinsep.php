...
<form class="form-signin" method="post" action="buildsep.php">  
	<?php 
        ...
        if ($meta == "200") {  
          ...
          echo "<script>alert('".$mets."');window.location = '".URL."/ceksep.php'</script>";
         }
          if($polik != ""){
          date_default_timezone_set('UTC');
          $tStamp = strval(time()-strtotime('1970-01-01 00:00:00'));
         ...
         switch(true){
           ...
           case $gig: ;break;
           case $bdm: ;break;
           default:echo '<script>alert("Nomor Rujukan Yang Anda Masukkan Tidak Sama Dengan Poli Tujuan Anda. Silahkan hubungi petugas!!");window.location = "'.URL.'/ceksep.php"</script>';break;
         }
